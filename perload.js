...
//         }
//     },
//     ReadGroups:(channel, data) => {
//         let validChannels = ["readgroups"];
//         if (validChannels.includes(channel)) {
//             ipcRenderer.send(channel, data);
//         }
//     },
//     NewGroup: (channel, func) => {
//         let validChannels = ["newgroup"];
//         if (validChannels.includes(channel)) {
//             ipcRenderer.on(channel, (event, ...args) => func(...args));
//         }
//     },
//     ReadChara:(channel, data) => {
//         let validChannels = ["readcharas"];
//         if (validChannels.includes(channel)) {
//             ipcRenderer.send(channel, data);
//         }
//     },
//     LoadChara: (channel, func) => {
//         let validChannels = ["loadcharas"];
//         if (validChannels.includes(channel)) {
//             ipcRenderer.on(channel, (event, ...args) => func(...args));
//         }
//     },
